...
class PilihBuah:
    def __init__(self, screen, scene_manager):
        ...
        # Animasi masuk
        self.cards[0]['pos'][1] = -300
        self.cards[1]['pos'][1] = -300
        self.cards[2]['pos'][1] = -300
    ...
    def draw_plant_card(self, card, index):
        ...
        shadow_rect = pygame.Rect(x + shadow_offset, y + shadow_offset, card_width, card_height)
        self.draw_rounded_rect(self.screen, (50, 50, 50, 100), shadow_rect, 30)
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            for card in self.cards:
                card_rect = pygame.Rect(card['pos'][0], card['pos'][1], 
                                       int(400 * card['scale']), int(280 * card['scale']))
    ...
    def update(self, dt):
        ...
        if self.animation_timer > 0.2:
            self.cards[0]['target_pos'][1] = 150
        if self.animation_timer > 0.4:
            self.cards[1]['target_pos'][1] = 150
    ...
    def draw(self):
        ...
        # Title with custom font - UPDATED
        title = self.font_title.render("Pilih Buah Favoritmu!", True, self.TEXT_WHITE)
        title_shadow = self.font_title.render("Pilih Buah Favoritmu!", True, (50, 50, 50))
